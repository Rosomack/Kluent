...
infix fun CharSequence.shouldMatch(regex: Regex) = assertTrue(this.matches(regex), "Expected $this to match ${regex.toString()}")
...
infix fun CharSequence.shouldNotMatch(regex: Regex) = assertFalse(this.matches(regex), "Expected $this to not match ${regex.toString()}")
